...
def main():
    ...
    pw_col = get_password_column(cur)
    if not pw_col:
        raise RuntimeError("Database schema missing password column (password or password_hash).")

    if pw_col == "password":
        insert_sql = "INSERT INTO Users (user_id, name, email, phone, password, role) VALUES (?, ?, ?, ?, ?, ?)"
    else:
        insert_sql = "INSERT INTO Users (user_id, name, email, phone, password_hash, role) VALUES (?, ?, ?, ?, ?, ?)"

    users = [(u[0], u[1], u[2], u[3], u[4], u[5]) for u in users_raw]
    ...
    found_posts = [
        ("found_001", "950000003", "Laptop", "Electronics", "Silver laptop – Apple logo", "2025-02-02",
         "Library study room", "Campus Security Office", "available"),
        ("found_002", "950000001", "Nike Hoodie", "Clothing", "Gray hoodie, size L", "2025-01-29", "Gym bench",
         "Campus Security Office", "available"),
        ("found_003", "950000003", "ID Card", "Documents", "Student ID card with lanyard", "2025-02-03", "Cafeteria",
         "Campus Security Office", "matched"),
        ("found_004", "950000004", "Car Keys", "Keys", "Toyota key fob found near Lot B", "2025-01-31", "Parking Lot B",
         "Campus Security Office", "available"),
        ("found_005", "950000011", "Black Phone", "Electronics", "iPhone with cracked screen", "2025-02-05",
         "Student Union floor", "Campus Security Office", "available"),
        ("found_006", "950000012", "Backpack", "Accessories", "Blue backpack with books inside", "2025-02-03",
         "Science Building hallway", "Campus Security Office", "available"),
        ("found_007", "950000013", "Wallet", "Accessories", "Brown leather wallet with cards", "2025-01-30",
         "Parking Lot A", "Campus Security Office", "matched"),
        ("found_008", "950000014", "Textbook", "Books", "Calculus book", "2025-02-05", "Math Building Room 201",
         "Campus Security Office", "available"),
        ("found_009", "950000015", "Green Water Bottle", "Other", "Hydro Flask", "2025-02-02", "Gym floor",
         "Campus Security Office", "available"),
        ("found_010", "950000016", "White Earbuds", "Electronics", "AirPods with charging case", "2025-02-01",
         "Library 2nd floor table", "Campus Security Office", "available"),
        ("found_011", "950000017", "Umbrella", "Other", "Black umbrella", "2025-02-04", "Main Hall",
         "Campus Security Office", "available"),
        ("found_012", "950000018", "Red Jacket", "Clothing", "North Face jacket, size M", "2025-01-28",
         "Cafeteria coat rack", "Campus Security Office", "available"),
        ("found_013", "950000019", "Prescription Glasses", "Accessories", "Ray-Ban frames", "2025-02-03", "Library",
         "Campus Security Office", "available"),
        ("found_014", "950000020", "U-Lock", "Keys", "Bike lock with keys", "2025-01-31", "Bike rack",
         "Campus Security Office", "available"),
        ("found_015", "950000002", "Silver Watch", "Accessories", "Digital watch", "2025-01-30",
         "Basketball court bleachers", "Campus Security Office", "matched"),
        ("found_016", "950000005", "USB Drive", "Electronics", "Small flash drive", "2025-02-05", "Computer lab desk",
         "Campus Security Office", "available"),
        ("found_017", "950000006", "Scarf", "Clothing", "Red knit scarf", "2025-01-29", "Theatre building",
         "Campus Security Office", "available"),
        ("found_018", "950000007", "Calculator", "Electronics", "Graphing calculator", "2025-02-04", "Math Building",
         "Campus Security Office", "available"),
        ("found_019", "950000008", "Sunglasses", "Accessories", "Aviator style sunglasses", "2025-02-01", "Quad bench",
         "Campus Security Office", "available"),
        ("found_020", "950000009", "Access Badge", "Documents", "Staff badge with photo", "2025-02-05",
         "Admin building", "Campus Security Office", "matched"),
        ("found_021", "950000010", "Black Hat", "Clothing", "Baseball cap", "2025-02-04", "Athletic field",
         "Campus Security Office", "available"),
        ("found_022", "950000011", "Earbuds", "Electronics", "Samsung wireless earbuds", "2025-01-30", "Bus stop bench",
         "Campus Security Office", "available"),
    ]
    matches = [
